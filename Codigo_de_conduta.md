...
O projeto é gerenciado por estudantes durante a execução da disciplina de Métodos de Desenvolvimento de Software da Universidade de Brasília. Assim, no interesse de promover um ambiente aberto e acolhedor, os colaboradores do projeto se comprometem a promover uma experiência agradável e positiva para todos.
...
- Assumir a responsabilidade por seus erros e aprendizado através da experiência.
...
- Intolerância religiosa, política, étnica ou de qualquer outro tipo.
...
Casos de comportamento inaceitáveis podem ser reportados ao entrar em contato qualquer colaborador. Todas as reclamações serão analisadas e investigadas e resultarão em uma resposta que será apropriada à circunstância. A equipe do projeto é
